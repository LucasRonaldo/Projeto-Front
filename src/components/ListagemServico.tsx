                                    ...
                                    {servicos.map(servicos => (
                                        <tr key={servicos.id}>
                                            ...
                                            <td className='col-3'>
                                                ...
                                                <Link className="btn  btn-secondary p-1  btn-sm" to={"/recuperar/senha/servico/" + servicos.id}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16">
